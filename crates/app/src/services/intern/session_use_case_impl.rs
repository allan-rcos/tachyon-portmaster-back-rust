...
#[derive(Clone)]
pub(crate) struct SessionUseCaseImpl<UR, RR, PR, UT, RT, A> {
...
impl<UR, RR, PR, UT, RT, A> SessionUseCaseImpl<UR, RR, PR, UT, RT, A> {
    /// Monta o caso de uso.
...
impl<UR, RR, PR, UT, RT, A> SessionUseCase for SessionUseCaseImpl<UR, RR, PR, UT, RT, A>
where
