...
#[derive(Clone)]
pub(crate) struct AccountUseCaseImpl<R, T, A, Q, C> {
...
impl<R, T, A, Q, C> AccountUseCaseImpl<R, T, A, Q, C> {
    /// Monta o caso de uso.
...
impl<R, T, A, Q, C> AccountUseCase for AccountUseCaseImpl<R, T, A, Q, C>
where
