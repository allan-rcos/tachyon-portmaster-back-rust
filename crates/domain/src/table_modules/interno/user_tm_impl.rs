...
use crate::models::interno::user_model::UserModel;
...
impl<G: IntIdGenerator, H: PasswordHasher> UserTMImpl<G, H> {
    ...
    fn validate_profile(name: &str, email: &str, errors: &mut Validation) {
    ...
    /// tentativa e erro.
    fn validate_password(password: &str, errors: &mut Validation) {
